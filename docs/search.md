...
- [维基百科-开放获取期刊列表](https://zh.wikipedia.org/wiki/開放獲取期刊列表)：了解不同期刊开放获取的规则，找到该期刊免费下载。
...
- [National Center for Biotechnology Information](https://www.ncbi.nlm.nih.gov/)生物医学文献检索系统，可以通过“Create alert”跟踪关键词。 注：以上四个网站及具体操作方法来自公众号丁香学术文章：[4个方便高效的文献订阅网站，助你实时紧追最新科研热点](https://mp.weixin.qq.com/s/EKbBk2ozAzv83ZEtOI3pJQ)，可参考使用方法。
...
- [集智俱乐部](https://swarma.org/)：人工智能、网络科学、认知科学等学科的综合社群，旗下“集智俱乐部”公众号、“集智斑图”小程序，颇有价值，入手某个学科时，建议读该学科的介绍，了解学科脉络。
...
- [MyHeritage](https://www.myheritage.com/)：用于创建家谱、族谱。可以通过 https://lastnames.myheritage.com/last-name/xxx 查询某个姓氏的区域分布情况（对欧美的记录更准确）。
- [中国国家调查数据库](http://www.cnsda.org/)：以“中国社会调查开放数据库（Chinese Social Survey Open Database,CSSOD)）和中国人民大学科学研究基金“数据高地项目”资助下的各项大型追踪项目和横截面调查数据为基础，数据涵盖了经济、综合、健康、社会、教育、企业、宗教、政治、科学和历史等领域。
...
- [左其盛经管新书点评](https://wemp.app/accounts/341ca554-e213-467c-a8e1-16f58604b3bf)：微信公众号ZuoQishengReading。个人认为是目前最好的书评人，因为价值观一致（反对伪科学、强调信息浓度和数据），新书的更新速度很快。该公众号的搜索功能非常友好，善用搜索有惊喜。缺点是毕竟是个人偏见，在小说方面与于子欣赏能力略有不同；另外以经管类书为主，也有不少历史、心理学，但总体分类上略有不足。
- [什么值得读](https://www.shenmezhidedu.com/)：一些书单的汇总和好文推荐。有价值的部分是后面分行业和技能的书单，如产品、运营、设计等。
...
- [Zlibrary](https://b-ok.cc/)：搜索引擎，以英文为主，也可搜索中文书籍，全免费，试用了一下，新书pdf找不到，老书pdf或新老书文字版都较方便找到。发现很多港台版的书能找到，真是个宝藏网站。已注册 [tcheng0407@gmail.com](mailto:tcheng0407@gmail.com)。墙内可看[Zlibrary](https://1lib.net/)。
...
- [ESV Bible](https://www.esv.org/)：ESV是现阶段《圣经》英文翻译中的较好版本，此网站含Study Bible，已注册[kb8newton@gmail.com](mailto:kb8newton@gmail.com)。
...
- [美国证券交易委员会-搜索页面](https://www.sec.gov/edgar/searchedgar/companysearch.html)：搜索年报、季报、招股说明书等重要信息披露。 注：美国上市公司，10-K为年报，10-Q为季报，8-K为重大事件说明，Form S-1为招股说明书。
...
- [GitHub万人以上关注用户榜单](https://github.com/search?utf8=✓&q=followers%3A>%3D10000&type=Users)：发现优质程序员。
- [清科研究中心历年榜单](https://www.pedata.cn/topranking/index.html)：投资界榜单，略有参考价值。
- [CCTV中国经济年度人物](https://baike.baidu.com/item/CCTV中国经济年度人物)：奖项为2001-2013年度，对最新商业信息了解作用不大，很可能有政治色彩。
...
- [生意参谋](https://github.com/tcheng0407/InfoToolkit/blob/master/beta.sycm.taobao.com)：阿里巴巴电商数据，需要开店铺后打开。可查询品类中各品牌商品，也可查询某品牌的全部产品线等。
...
- [微信指数](https://github.com/tcheng0407/InfoToolkit/blob/master)：在微信小程序中打开，基于微信数据，最多只能查看90天。
...
- [战略控制指数](https://books.google.com/books?id=wDoWSocjGnkC&pg=PA287&lpg=PA287&dq=战略控制指数+斯莱沃斯基&source=bl&ots=e8dco9x2ey&sig=ACfU3U29eaOvSy0LxOI-q1SXcoHIMRfT6w&hl=en&sa=X&ved=2ahUKEwir75-Qh8jlAhXkG6YKHf3JBwoQ6AEwAXoECAcQBA#v=onepage&q=战略控制指数 斯莱沃斯基&f=false)：战略控制指数是企业为保护所创造的利润流的能力，从重要到次要包括：行业标准、价值链、市场占有率、客户信息流、品牌/专利/版权、产品提前期、10-20%的成本优势等。
- [明茨伯格的战略5P模型](https://wiki.mbalib.com/wiki/明茨伯格的战略5P模型)：借鉴市场营销学中的四要素(4P)的提法，提出企业战略是由五种规范的定义阐述的，即计划（Plan）、计策（Ploy）、模式（Pattern）、定位（Position）和观念（Perspective）。
- [3C战略三角模型](https://wiki.mbalib.com/wiki/3C战略三角模型)：由日本战略研究的领军人物大前研一（Kenichi Ohmae）提出的，他强调成功战略有三个关键因素，在制定任何经营战略时，都必须考虑这三个因素，即公司自身（Corporation）、公司顾客（Customer）、竞争对手（Competition）。
- [波特五力分析模型](https://wiki.mbalib.com/wiki/波特五力分析模型)：五力分别是： 供应商的议价能力、购买者的议价能力、潜在竞争者进入的能力、替代品的替代能力、行业内竞争者现在的竞争能力。五种力量的不同组合变化最终影响行业利润潜力变化。
...
- [myNotreDame](http://my.nd.edu/)：ND 校友信息页面，可以查到校友信息和校友资源。我的账号为 tcheng0407， 绑定邮箱为 [kb8newton@gmail.com](mailto:kb8newton@gmail.com)。
...
- [ProcessOn在线作图](https://github.com/tcheng0407/InfoToolkit/blob/master/www.processon.com)：流程图、思维导图、线框图、原型图等。
...
- [FlatIcon](https://github.com/tcheng0407/InfoToolkit/blob/master/www.flaticon.com):秋叶六星推荐，顾名思义以扁平类图标为主，可单个也可全套下载。另外可通过[图标平铺](https://pattern.flaticon.com/)进入背景平铺的功能，用于设计壁纸。
...
- [60logo](https://github.com/tcheng0407/InfoToolkit/blob/master/60logo.com)：国内logo网站，需要关注公众号可下载。
...
- [WikiHow](https://www.wikihow.com/Main-Page)：技能类问题解答，中文网站[戳此](https://zh.wikihow.com/首页)。
...
- [禁片目录](https://chinadigitaltimes.net/space/禁片目录)：中国数字时代整理。
...
- [白描网页版](https://web.baimiaoapp.com/)：OCR 工具，已购买普通会员版，注册邮箱 [tcheng87@163.com](mailto:tcheng87@163.com)。
...
- [UZER.ME云端超级应用空间](https://github.com/tcheng0407/InfoToolkit/blob/master/uzer.me)：包括Office的三件套，甚至包含XMind、Photoshop、Matlab等常用付费软件。界面和电脑几乎完全一样，但只能保存（有1G储存空间）而无法在线同步编辑。已用微信和手机号注册。
...
- [维基百科:更优秀条目写作指南](https://zh.wikipedia.org/wiki/Wikipedia:更优秀条目写作指南)：如何更清晰、更科学、更客观地写作。
